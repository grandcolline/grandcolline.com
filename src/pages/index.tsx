    ...
    <>
      ...
      <div className="bg-white p-10">
        <div className="flex flex-col gap-1 text-center items-center">
          ...
          <p className="text-sm leading-normal text-gray-400 flex justify-center items-center my-2">
        ...
        <div className="flex justify-center items-center gap-2 my-2">
          ...
          >
            <svg
              ...
              viewBox="0 0 48 48"
              className="w-8 h-8 text-gray-400 hover:text-blue-300 fill-current"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-8 h-8 text-gray-400 hover:text-orange-300 fill-current"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 30 30"
              className="w-8 h-8 text-gray-400 hover:text-black fill-current"
            >
